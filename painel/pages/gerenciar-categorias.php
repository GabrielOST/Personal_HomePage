...
<div class="box-content">
	<h2><i class="far fa-id-card"></i> Categorias Cadastradas</h2>
	<div class="wraper-table">
		<table>
			...
			<tr>
				...
				<td><a class="btn order" href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-categorias?order=up&id=<?php echo $value['id']?>"><i class="fas fa-angle-up"></i></a></td>
				<td><a class="btn order" href="<?php echo INCLUDE_PATH_PAINEL?>gerenciar-categorias?order=down&id=<?php echo $value['id']?>"><i class="fas fa-angle-down"></i></a></td>
			</tr>
	...
	<div class="paginacao">
		<?php
			$totalPaginas = ceil(count(Painel::selectAll('tb_site.categorias')) / $porPagina); // Queremos 2 por pagina
